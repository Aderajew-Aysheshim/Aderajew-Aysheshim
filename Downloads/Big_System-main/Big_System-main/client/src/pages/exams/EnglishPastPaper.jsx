...
const EnglishPastPaper = () => {
  ...
  const pastPapers = [
    {
      id: 1,
      title: "English Final Exam - 2023",
      semester: "Fall Semester",
      date: "December 2023",
      duration: "3 Hours",
      type: "Final Exam",
      fileUrl: "/api/past-papers/english-2023-final.pdf",
      thumbnail: "/api/placeholder/400/250"
    },
    {
      id: 2,
      title: "English Midterm Exam - 2023",
      semester: "Fall Semester",
      date: "October 2023",
      duration: "2 Hours",
      type: "Midterm Exam",
      fileUrl: "/api/past-papers/english-2023-midterm.pdf",
      thumbnail: "/api/placeholder/400/250"
    },
    {
      id: 3,
      title: "English Final Exam - 2022",
      semester: "Spring Semester",
      date: "May 2022",
      duration: "3 Hours",
      type: "Final Exam",
      fileUrl: "/api/past-papers/english-2022-final.pdf",
      thumbnail: "/api/placeholder/400/250"
    },
    {
      id: 4,
      title: "English Midterm Exam - 2022",
      semester: "Spring Semester",
      date: "March 2022",
      duration: "2 Hours",
      type: "Midterm Exam",
      fileUrl: "/api/past-papers/english-2022-midterm.pdf",
      thumbnail: "/api/placeholder/400/250"
    },
    {
      id: 5,
      title: "English Final Exam - 2021",
      semester: "Fall Semester",
      date: "December 2021",
      duration: "3 Hours",
      type: "Final Exam",
      fileUrl: "/api/past-papers/english-2021-final.pdf",
      thumbnail: "/api/placeholder/400/250"
    }
  ];
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 to-indigo-900">
        <div className="text-center">
          ...
          <p className="text-slate-300 font-semibold">Loading English Past Papers...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-indigo-900 pt-20 pb-32">
      {/* Header */}
      <div className="max-w-7xl mx-auto px-6 mb-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-4xl font-black text-white mb-2">English Past Papers</h1>
              <p className="text-slate-400">AASTU Freshman English Exam Archive</p>
            </div>
          </div>
          {isPremium && (
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {pastPapers.map((paper) => (
            <div
              key={paper.id}
              className="group relative bg-slate-900/30 backdrop-blur-2xl rounded-2xl border border-slate-700/40 overflow-hidden hover:bg-slate-800/30 hover:border-indigo-500/30 transition-all duration-500"
            >
              {/* Thumbnail */}
          ...
          <div className="mt-12 bg-gradient-to-r from-yellow-500/20 to-orange-600/20 rounded-2xl p-8 border border-yellow-500/30">
            <div className="text-center">
              ...
              <p className="text-slate-300 mb-6">
                Get access to 5+ years of AASTU english past papers with detailed solutions.
              </p>
              <Link
...
export default EnglishPastPaper;
